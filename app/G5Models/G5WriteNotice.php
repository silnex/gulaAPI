...
class G5WriteNotice extends G5Model
{
    use BelongToG5Member;

    protected $table = 'g5_write_notice';

    protected $bo_table = 'notice';
    ...
    {
        return $this->hasMany(G5WriteNotice::class, 'wr_parent', 'wr_id')->where('wr_is_comment', '=', '1');
    }
    ...
    public function parent()
    {
        if ($this->wr_is_comment) {
            return $this->belongsTo(G5WriteNotice::class, 'wr_id', 'wr_parent')->where('wr_is_comment', '=', '0');
        } else {
